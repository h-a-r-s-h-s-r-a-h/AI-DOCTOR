...
const AiDoctor = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await fetch("http://127.0.0.1:8001/doc_assit", {
      method: "POST",
      headers: {
    ...
    <div>
      ...
      <div id="main">
        <section id="featured-services" className={styles.featuredservices8}>
          ...
          >
            <h1>Report</h1>
            <p style={{fontSize:"12px"}}>*AI doctor is not a substitute for professional medical advice.</p>
            <ul className="list-unstyled">
              {/* <h2>Disease : {report.Disease}</h2> */}
              <hr style={{ width: "50%" }} />
              {/* <h3>Assessment About Disease</h3>
              <textarea
                ...
                disabled
              /> */}
              <h3>Suggested Diagnosis and Treatment</h3>
              <textarea
                value={report.data}
                onChange={handleChange}
